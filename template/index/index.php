    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="<?= $GLOBALS['INDEX'] ?>?action=restaurantes" role="button">Restaurantes <span class="glyphicon glyphicon-cutlery"/></a></p>
        </div>
        <div class="col-md-4">
          <h2>Pinchos <span class="glyphicon glyphicon-search"/></h2>
          <p>Vea los deliciosos pinchos</p>
          <p><a class="btn btn-default" href="<?= $GLOBALS['INDEX'] ?>?action=pinchos" role="button">Pinchos <span class="glyphicon glyphicon-search"/></a></p>
       </div>
        <div class="col-md-4">
          <h2>Finalistas<span class="glyphicon glyphicon-tower"/></h2>
          <p>Finalistas y ganadores del concurso</p>
          <p><a class="btn btn-default" href="<?= $GLOBALS['INDEX'] ?>?action=finalistas" role="button">Finalistas <span class="glyphicon glyphicon-tower"/></a></p>
        </div>
      </div>
